    ...
    for HeadState in range(numHeadStates):
        ...
        for key in possibleKeys:
            ...
            for action in actions:
                ...
                value = Belief@C[action]  + gamma *(sensingcost + (Belief@T[action])@V_head.T)
...
if __name__ == "__main__":
    ...
    print(thm1(sensingcost, result, actions, windowLength, deepcopy(C), T, gamma, numHeadStates, V_head))
